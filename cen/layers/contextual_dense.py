...
class ContextualDense(Layer):
    ...
    def get_config(self):
        config = {
            ...
            "kernel_regularizer": regularizers.serialize(self.regularizers["kernels"]),
            "bias_regularizer": regularizers.serialize(self.regularizers["biases"]),
            "kernel_constraint": constraints.serialize(self.constraints["kernels"]),
            "bias_constraint": constraints.serialize(self.constraints["biases"]),
        }
...
class ContextualAffineDense(ContextualDense):
    ...
    def get_config(self):
        config = {
            ...
            "gen_kernel_initializer": initializers.serialize(self.gen_kernel_initializer),
            "gen_bias_initializer": initializers.serialize(self.gen_bias_initializer),
            "gen_kernel_regularizer": regularizers.serialize(self.gen_kernel_regularizer),
            "gen_bias_regularizer": regularizers.serialize(self.gen_bias_regularizer),
            "gen_kernel_constrain": regularizers.serialize(self.gen_kernel_constraint),
            "gen_bias_constraint": regularizers.serialize(self.gen_bias_constraint),
        }
...
class ContextualConvexDense(ContextualDense):
    ...
    def get_config(self):
        config = {
            ...
            "dict_kernel_initializer": initializers.serialize(self.dict_kernel_initializer),
            "dict_bias_initializer": initializers.serialize(self.dict_bias_initializer),
            "dict_kernel_regularizer": regularizers.serialize(self.dict_kernel_regularizer),
            "dict_bias_regularizer": regularizers.serialize(self.dict_bias_regularizer),
            "dict_kernel_constrain": regularizers.serialize(self.dict_kernel_constraint),
            "dict_bias_constraint": regularizers.serialize(self.dict_bias_constraint),
        }
